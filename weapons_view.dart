...
import 'package:ProGuidance/viewmodels/weapons_view_model.dart';
...
class _WeaponsViewState extends State<WeaponsView>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => WeaponsViewModel(null, animationController),
      child: Builder(
        builder: (context) {
          final viewModel = Provider.of<WeaponsViewModel>(context);
          return Container(
