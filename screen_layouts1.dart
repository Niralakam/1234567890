...
import 'package:proguidancelayout/viewmodels/screen_layouts_view_model1.dart';
import 'package:provider/provider.dart';
import 'package:reactive_forms/reactive_forms.dart';

class ScreenLayouts1 extends StatefulWidget {
  @override
  _ScreenLayoutsState createState() => _ScreenLayoutsState();
}

class _ScreenLayoutsState extends State<ScreenLayouts1>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ScreenLayoutsViewModel1(
        null,
        animationController,
      ),
      child: Builder(
        builder: (context) {
          final viewModel = Provider.of<ScreenLayoutsViewModel1>(context);
          return Container(
