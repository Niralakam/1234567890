...
import 'package:proguidancelayout/viewmodels/screen_layouts_view_model3.dart';
import 'package:provider/provider.dart';
import 'package:reactive_forms/reactive_forms.dart';

class ScreenLayouts3 extends StatefulWidget {
  @override
  _ScreenLayoutsState createState() => _ScreenLayoutsState();
}

class _ScreenLayoutsState extends State<ScreenLayouts3>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ScreenLayoutsViewModel3(
        null,
        animationController,
      ),
      child: Builder(
        builder: (context) {
          final viewModel = Provider.of<ScreenLayoutsViewModel3>(context);
          return Container(
