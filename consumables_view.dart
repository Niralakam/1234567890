...
import 'package:ProGuidance/viewmodels/consumablesViewModel.dart';
...
class ConsumablesView extends StatefulWidget {
  @override
  _ConsumablesViewState createState() => _ConsumablesViewState();
}
...
class _ConsumablesViewState extends State<ConsumablesView>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ConsumablesViewModel(null, animationController),
      child: Builder(
        builder: (context) {
          final viewModel = Provider.of<ConsumablesViewModel>(context);
          return Container(
