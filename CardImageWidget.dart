...
class _CardImageWidgetState extends State<CardImageWidget>
  ...
  void initState() {
    animationController = AnimationController(
      duration: Duration(milliseconds: NiralakamSharedTheme.milliseconds),
      vsync: this,
    );
    super.initState();
  }
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget child) {
        return FadeTransition(
          ...
          child: Transform(
            transform:
                NiralakamSharedTheme.subTransform(widget.mainScreenAnimation),
            child: Container(
              padding:
                  NiralakamSharedTheme.edgeInsetsPaddingDoubleExtraLargeLTRB,
              child: ClipRRect(
